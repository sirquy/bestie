...
export const TELEGRAM_CHANNEL: ChannelDescriptor = {
  ...
  commands: [
    ...
    { command: "memory", description: "Show or control local memory", aliases: ["memory list", "memory analyze", "memory cleanup dry-run", "memory maintenance status", "memory maintenance install", "memory maintenance remove", "memory pending", "memory pause", "memory resume"], native: true },
