    ...
    llm: {
      ...
      profiles: {
        ...
        [profileId]: {
          ...
          mode,
          ...(catalog.runtimeProvider === "claude-cli" || catalog.runtimeProvider === "codex-cli" || catalog.runtimeProvider === "gemini-cli" || catalog.runtimeProvider === "gemini" ? {} : { baseUrl: (options.baseUrl?.trim() || requireProviderBaseUrl(catalog.defaultBaseUrl)).replace(/\/+$/, "") }),
