...
```json
{
  ...
  "internalTools": {
    "policies": {
      ...
      "internal.send_photo": "ask",
      "internal.send_file": "ask"
    },
    "exec": {
      "timeoutMs": 120000
    }
